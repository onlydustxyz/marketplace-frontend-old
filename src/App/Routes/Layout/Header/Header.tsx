  ...
  return (
    <header className="header pt-[12px]">
      ...
      <div className="h-[60px] md:h-[120px] max-w-full flex flex-col">
        <div className="absolute mt-3 md:mt-0 md:h-[120px] z-10 w-full grid items-center px-3 md:px-12 grid-areas-header-mobile-v1 grid-cols-header-mobile-v1 md:grid-areas-header-desktop-v1 md:grid-cols-header-desktop-v1 backdrop-blur-[7px] md:backdrop-blur-[0px]">
